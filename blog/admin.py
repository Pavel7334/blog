...
class BlogAdmin(admin.ModelAdmin):
    ...
    save_on_top = True
    # fields = ('title', 'slug', 'cat', 'content', 'photo', 'get_html_photo_inner', 'is_published', 'time_created', 'time_updated')
    # readonly_fields = ('get_html_photo_inner', 'time_created', 'time_updated')
    fields = (
    'title', 'slug', 'cat', 'content', 'photo', 'get_html_photo_inner', 'is_published', 'time_created', 'time_update')
    ...
    get_html_photo_inner.short_description = 'Фото'
